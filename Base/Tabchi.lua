...
local Addall1 = "⇜ کاربر مورد نظر درحال اد شدن در تمامیه گروه ها میباشد ...\n⇜ در هر <code>SLEEP</code> ثانیه کاربر موردنظر شما به <code>1</code> گروه دعوت میشود .\n⇜ لطفا صبور باشید و تا پایان عملیات دستوری ارسال ننمایید !"
